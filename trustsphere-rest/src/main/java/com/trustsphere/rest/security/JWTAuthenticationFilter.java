...
public class JWTAuthenticationFilter implements ContainerRequestFilter {
    ...
    public void init() {
        try {
            // Initialize a signing key from configuration
            ...
            LOGGER.error("Failed to initialize JWT Authentication Filter", e);
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        ...
        try {
            ...
            LOGGER.info("Successfully authenticated user: {}", claims.getSubject());
            ...
            LOGGER.warn("Invalid JWT token argument", e);
    ...
    private void validateClaims(Claims claims) {
        ...
        // e.g., check if user is still active, validate specific role requirements,
        // etc.
    }
    ...
    private List<String> extractRoles(Claims claims) {
        ...
        LOGGER.warn("Invalid roles claim format, defaulting to empty roles");
