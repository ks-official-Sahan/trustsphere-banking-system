...
public class AccountResource {
    ...
    public Response createAccount(@Valid @NotNull AccountDTO dto) {
        try {
            ...
            LOGGER.log(Level.WARNING, "Invalid account data: " + e.getMessage(), e);
            return Response
            ...
            LOGGER.log(Level.WARNING, "Account creation rule violation: " + e.getMessage(), e);
            return Response
            ...
            LOGGER.log(Level.WARNING, "Account validation failed: " + e.getMessage(), e);
            return Response
    ...
    public Response getAccountById(
        ...
        try {
            ...
            LOGGER.log(Level.WARNING, "Account not found: " + id + " : " + e.getMessage(), e);
            return Response
                        .status(Response.Status.NOT_FOUND)
                        .entity(new ErrorResponse("ACCOUNT_NOT_FOUND", "Account with ID " + id + " not found"))
                    .build();
            ...
            LOGGER.log(Level.WARNING, "Unauthorized account access attempt: " + id, e);
            return Response
            ...
            LOGGER.log(Level.SEVERE, "Failed to retrieve account: " + id, e);
            return Response
                    .status(Response.Status.INTERNAL_SERVER_ERROR)
    ...
    public Response listActiveByUser(
        ...
        try {
            ...
            LOGGER.log(Level.WARNING, "Unauthorized user account access attempt: " + userId, e);
            return Response
                    .status(Response.Status.FORBIDDEN)
                    .entity(new ErrorResponse("UNAUTHORIZED_ACCESS", "Access denied"))
                    .build();
            ...
            LOGGER.log(Level.WARNING, "Invalid user ID: " + userId, e);
            return Response
                    .status(Response.Status.NOT_FOUND)
            ...
            LOGGER.log(Level.SEVERE, "Failed to retrieve user accounts: " + userId, e);
            return Response
                    .status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(new ErrorResponse("RETRIEVAL_FAILED", "Internal server error"))
                    .build();
    ...
    public Response updateStatus(
        ...
        try {
            ...
            String currentUser = securityContext.getUserPrincipal().getName();
            LOGGER.info("Updating account status: " + id + " to " + status + " by: " + currentUser);

            //boolean updated = accountService.updateStatus(id, status, reason, currentUser);
            accountService.updateStatus(id, status);

            LOGGER.info("Account status updated successfully: " + id + " to " + status);
            return Response
                    .noContent()
                    .build();
            ...
            LOGGER.log(Level.WARNING, "Invalid status transition: " + e.getMessage(), e);
            return Response
                    .status(Response.Status.NOT_MODIFIED)
            ...
            LOGGER.log(Level.SEVERE, "Failed to update account status: " + id, e);
            return Response
                    .status(Response.Status.INTERNAL_SERVER_ERROR)
