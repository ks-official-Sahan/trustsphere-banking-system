...
public class NotificationResource {
    ...
    public Response getNotificationsByUser(
        ...
        try {
            ...
            if (!isAdmin && !currentUser.equals(userId)) {
                LOGGER.warn("Unauthorized notification access attempt: user={} requested={}", currentUser, userId);
                return Response
            ...
            LOGGER.info("Retrieving notifications for user: {} page: {} size: {} includeRead: {}", userId, page, size, includeRead);
            ...
            List<NotificationDTO> notifications = notifService.getNotificationsByUser(userId, offset, size);
            ...
            LOGGER.warn("Unauthorized notification access: {}", userId, e);
            return Response
                    .status(Response.Status.FORBIDDEN)
                    .entity(new ErrorResponse("UNAUTHORIZED_ACCESS", "Access denied"))
                    .build();
            ...
            LOGGER.warn("Invalid user notification request: {}", e.getMessage(), e);
            return Response
            ...
            LOGGER.warn("Failed to retrieve user notifications: {}", userId, e);
            return Response
    ...
    public Response getNotificationsByType(
        ...
        try {
            ...
            LOGGER.info("Retrieving notifications by type: {} for user: {} page: {} size: {}", notificationType, currentUser, page, size);
            ...
            int offset = (page - 1) * size;
            List<NotificationDTO> notifications = notifService.getNotificationsByType(notificationType,  offset, size);
            ...
            LOGGER.warn("Invalid notification type request: {}", e.getMessage(), e);
            return Response
                    .status(Response.Status.BAD_REQUEST)
            ...
            LOGGER.warn("Failed to retrieve notifications by type: {}", type, e);
            return Response
                    .status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(new ErrorResponse("RETRIEVAL_FAILED", "Internal server error"))
                    .build();
